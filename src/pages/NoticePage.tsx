...
const NOTICES = [
  {
    id: 1,
    category: '공지',
    title: '세미콜론 서비스 오픈 안내',
    date: '2026.01.01',
    content: '안녕하세요. 취미 거래 플랫폼 세미콜론이 정식 오픈했습니다. 많은 이용 부탁드립니다.'
  },
  {
    id: 2,
    category: '이벤트',
    ...
    <div className="min-h-screen bg-white py-6 pb-20">
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="divide-y divide-neutral-200 border-t border-b border-neutral-200">
          {NOTICES.map((notice) => (
            <div key={notice.id} className="py-5 px-2 hover:bg-neutral-50 transition-colors cursor-pointer group">
