...
const SocialLoginCallbackPage = lazy(
  () => import("./pages/SocialLoginCallbackPage"),
);
...
const EmailVerificationPendingPage = lazy(
  () => import("./pages/EmailVerificationPendingPage"),
);
...
const SettlementAccountPage = lazy(
  () => import("./pages/SettlementAccountPage"),
);
...
const CategoryManagePage = lazy(
  () => import("./pages/admin/CategoryManagePage"),
);
